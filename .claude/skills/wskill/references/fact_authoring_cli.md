...
| `wcl editor wdoc/book/main.wcl` | Browser IDE: file tree + WCL editing with LSP, a preview pane with click-to-comment review, and Edit buttons that jump from a rendered unit to its source |
