...
The per-spec summary of the build-side protocol: judge an implementation, record the verdict, control the merge. Build mode's runbooks (the orchestrator loop, verification, review, fix-and-merge) are the full versions of each step here.
