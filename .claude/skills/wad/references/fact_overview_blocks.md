...
Who populates: hand — stakeholders and RACI at framing time, an `adr` at the moment each decision is made (with its `adr_option` children when alternatives were genuinely weighed; a convention-recording ADR honestly has none).
