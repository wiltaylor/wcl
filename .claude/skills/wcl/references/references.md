...
Use `&InterfaceName` as the field type. The accepted values are exactly those that satisfy [the interface](../references/interfaces.md) — every required field, with compatible types.
