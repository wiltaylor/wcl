...
| --- | --- | --- |
| $ARGUMENTS | The wdoc block or render concept to look up. | Take it from the user's request — e.g. the block kind, template, or render target they asked about. If empty, summarise the reference and ask what they need. |
