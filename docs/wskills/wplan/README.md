...
A **wskill**: one self-contained folder capturing everything about *wplan* —
planning a software project as a gated WCL pipeline (interview, research, PRD,
a DAG of parallel-safe specs, and self-contained markdown briefs) — as a single
WCL data model, projected into a human-readable book and a Claude Code skill
(plus optional presentation-deck and training-course views).
