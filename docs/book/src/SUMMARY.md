...
- [Variables and Scoping](./guide/variables-and-scoping.md)
- [Control Flow](./guide/control-flow.md)
  - [For Loops](./guide/for-loops.md)
  - [If/Else](./guide/if-else.md)
- [Functions](./guide/functions.md)
  - [String Functions](./guide/functions-string.md)
  - [Math Functions](./guide/functions-math.md)
  - [Collection Functions](./guide/functions-collection.md)
  - [Higher-Order Functions](./guide/functions-higher-order.md)
  - [Aggregate Functions](./guide/functions-aggregate.md)
  - [Hash & Encoding Functions](./guide/functions-hash-encoding.md)
  - [Type Coercion Functions](./guide/functions-type-coercion.md)
  - [Reference & Query Functions](./guide/functions-ref-query.md)
- [Schemas](./guide/schemas.md)
- [Decorators](./guide/decorators.md)
  - [Built-in Decorators](./guide/decorators-builtin.md)
  - [Decorator Schemas](./guide/decorator-schemas.md)
- [Macros](./guide/macros.md)
  - [Function Macros](./guide/macros-function.md)
...
- [Expression Evaluation](./reference/evaluation.md)
- [Scoping Rules](./reference/scoping.md)
- [Evaluation Pipeline](./reference/pipeline.md)

# Appendix

- [EBNF Grammar](./appendix/ebnf.md)
- [Error Codes](./appendix/error-codes.md)
- [Comparison with Other Formats](./appendix/comparison.md)
