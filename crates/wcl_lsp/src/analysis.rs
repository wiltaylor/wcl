...
fn type_expr_to_string(te: &wcl_lang::lang::ast::TypeExpr) -> String {
    match te {
        ...
        wcl_lang::lang::ast::TypeExpr::OffsetDateTime(_) => "offset_datetime".into(),
        wcl_lang::lang::ast::TypeExpr::LocalDateTime(_) => "local_datetime".into(),
        wcl_lang::lang::ast::TypeExpr::LocalTime(_) => "local_time".into(),
