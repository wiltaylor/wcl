...
impl LanguageServer for WclLanguageServer {
    ...
    async fn goto_definition(
        ...
        let result = doc
            .analysis
            .as_ref()
            .and_then(|a| crate::lsp::definition::goto_definition(a, offset, &doc.rope, uri));
    ...
    async fn document_symbol(
        ...
        let result = doc.analysis.as_ref().map(|a| {
            DocumentSymbolResponse::Nested(crate::lsp::symbols::document_symbols(&a.ast, &doc.rope))
        });
    ...
    async fn completion(&self, params: CompletionParams) -> Result<Option<CompletionResponse>> {
        ...
        let offset = lsp_position_to_offset(pos, &doc.rope);
        let result = doc.analysis.as_ref().map(|a| {
            CompletionResponse::Array(crate::lsp::completion::completions(a, &doc.source, offset))
        });
    ...
    async fn signature_help(&self, params: SignatureHelpParams) -> Result<Option<SignatureHelp>> {
        ...
        let offset = lsp_position_to_offset(pos, &doc.rope);
        let result =
            crate::lsp::signature_help::signature_help(&doc.source, offset, doc.analysis.as_ref());
    ...
    async fn formatting(&self, params: DocumentFormattingParams) -> Result<Option<Vec<TextEdit>>> {
        ...
        let result = crate::lsp::formatting::format_document(&doc.source);
