use serde::de::{self, Visitor, MapAccess, SeqAccess, DeserializeSeed, EnumAccess, VariantAccess};
...
impl<'de> de::Deserializer<'de> for Deserializer {
    ...
    fn deserialize_any<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            Value::List(items) => {
                let seq = SeqDeserializer { iter: items.into_iter() };
                visitor.visit_seq(seq)
            }
            Value::Map(map) => {
                let map_de = MapDeserializer { iter: map.into_iter(), value: None };
            ...
            Value::BlockRef(br) => {
                ...
                if !br.labels.is_empty() {
                    map.insert("labels".to_string(), Value::List(
                        br.labels.into_iter().map(Value::String).collect()
                    ));
                }
            ...
            Value::Function(_) => Err(Error::Message("cannot deserialize function values".to_string())),
        }
    }
    ...
    fn deserialize_bool<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            Value::Bool(b) => visitor.visit_bool(b),
            _ => Err(Error::TypeMismatch { expected: "bool".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_i8<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "i8".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_i16<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "i16".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_i32<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "i32".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_i64<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            Value::Int(i) => visitor.visit_i64(i),
            _ => Err(Error::TypeMismatch { expected: "i64".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_u8<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "u8".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_u16<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "u16".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_u32<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "u32".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_u64<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "u64".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_f32<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "f32".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_f64<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "f64".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_char<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "char".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_str<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            Value::String(s) => visitor.visit_string(s),
            Value::Identifier(s) => visitor.visit_string(s),
            _ => Err(Error::TypeMismatch { expected: "string".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_unit<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "null".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_seq<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::TypeMismatch { expected: "list".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_map<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            Value::BlockRef(br) => {
                ...
                if !br.labels.is_empty() {
                    map.insert("labels".to_string(), Value::List(br.labels.into_iter().map(Value::String).collect()));
                }
                for (k, v) in br.attributes {
                    map.insert(k, v);
                }
            ...
            _ => Err(Error::TypeMismatch { expected: "map".to_string(), got: self.value.type_name().to_string() }),
        }
    }
    ...
    fn deserialize_enum<V: Visitor<'de>>(self, _name: &'static str, _variants: &'static [&'static str], visitor: V) -> Result<V::Value, Error> {
        match self.value {
            ...
            _ => Err(Error::Message("enum deserialization requires string".to_string())),
        }
    }
...
impl<'de> MapAccess<'de> for MapDeserializer {
    ...
    fn next_key_seed<K: DeserializeSeed<'de>>(&mut self, seed: K) -> Result<Option<K::Value>, Error> {
        match self.iter.next() {
            Some((key, value)) => {
                ...
                seed.deserialize(Deserializer::from_value(Value::String(key))).map(Some)
            }
            None => Ok(None),
        }
    }
    ...
    fn next_value_seed<V: DeserializeSeed<'de>>(&mut self, seed: V) -> Result<V::Value, Error> {
        let value = self.value.take().ok_or_else(|| Error::Message("value missing".to_string()))?;
