...
pub const CODECS_LIBRARY_WCL: &str = crate::assets::CODECS_LIBRARY_WCL;
pub const HTML_LIBRARY_WCL: &str = crate::assets::HTML_LIBRARY_WCL;
pub const SVG_LIBRARY_WCL: &str = crate::assets::SVG_LIBRARY_WCL;
pub const CSS_LIBRARY_WCL: &str = crate::assets::CSS_LIBRARY_WCL;
pub const WDOC_LIBRARY_WCL: &str = crate::assets::WDOC_LIBRARY_WCL;

pub fn embedded_libraries() -> Vec<EmbeddedLibrary> {
    crate::assets::embedded_libraries()
}
