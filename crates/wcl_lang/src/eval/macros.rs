...
fn type_expr_key(type_expr: &TypeExpr) -> String {
    match type_expr {
        ...
        TypeExpr::OffsetDateTime(_) => "offset_datetime".to_string(),
        TypeExpr::LocalDateTime(_) => "local_datetime".to_string(),
        TypeExpr::LocalTime(_) => "local_time".to_string(),
...
impl<'a> MacroExpander<'a> {
    ...
    fn value_matches_type(value: &Value, type_expr: &TypeExpr) -> bool {
        match type_expr {
            ...
            TypeExpr::OffsetDateTime(_) => matches!(value, Value::OffsetDateTime(_)),
            TypeExpr::LocalDateTime(_) => matches!(value, Value::LocalDateTime(_)),
            TypeExpr::LocalTime(_) => matches!(value, Value::LocalTime(_)),
    ...
    fn value_type_name(value: &Value) -> String {
        match value {
            ...
            Value::LocalDateTime(_) => "local_datetime".to_string(),
            Value::LocalTime(_) => "local_time".to_string(),
