...
pub fn render_resolved_diagram_svg(diagram: &mut Diagram) -> String {
    ...
    let pan_zoom_controls = if pan_zoom {
        "<div class=\"wdoc-diagram-pan-zoom-controls\" data-wdoc-pan-zoom-controls=\"true\">\
         <button class=\"wdoc-diagram-pan-zoom-button\" type=\"button\" data-wdoc-pan-zoom-control=\"in\" aria-label=\"Zoom in\" title=\"Zoom in\">+</button>\
         <button class=\"wdoc-diagram-pan-zoom-button\" type=\"button\" data-wdoc-pan-zoom-control=\"out\" aria-label=\"Zoom out\" title=\"Zoom out\">-</button>\
         <button class=\"wdoc-diagram-pan-zoom-button wdoc-diagram-pan-zoom-reset\" type=\"button\" data-wdoc-pan-zoom-control=\"reset\" aria-label=\"Reset zoom\" title=\"Reset zoom\">Reset</button>\
         </div>"
    } else {
        ""
    };
...
fn layout_graph_subset(
    ...
    match align {
        Alignment::Layered => crate::render::graph_layout::layout_layered(
            &mut layout_children,
            &local_connections,
            parent,
            gap,
        ...
        Alignment::Force => crate::render::graph_layout::layout_force(
            &mut layout_children,
            &local_connections,
            parent,
            gap,
        ...
        Alignment::Radial => crate::render::graph_layout::layout_radial(
            &mut layout_children,
            &local_connections,
            parent,
            gap,
        ...
        Alignment::Grid => crate::render::graph_layout::layout_grid(
            &mut layout_children,
            &local_connections,
            parent,
            gap,
...
fn apply_intrinsic_container_size(node: &mut ShapeNode, connections: &[Connection]) {
    if node.kind_name == "wdoc::draw::terminal" {
        let (width, height) = crate::render::terminal::intrinsic_size(&node.attrs);
...
fn render_shape_svg(node: &ShapeNode, svg: &mut String) {
    ...
    match node.kind {
        ...
        ShapeKind::Custom => {
            if node.kind_name == "wdoc::draw::terminal" {
                crate::render::terminal::render_terminal_svg(node, svg);
                rendered_children = true;
...
fn diagram_runtime_js() -> String {
    static DIAGRAM_RUNTIME: OnceLock<Result<String, String>> = OnceLock::new();
    DIAGRAM_RUNTIME
        .get_or_init(load_diagram_runtime_js)
        .as_ref()
