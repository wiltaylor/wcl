...
pub fn block_ref_to_json(br: &wcl::BlockRef) -> serde_json::Value {
    ...
    if !br.labels.is_empty() {
        obj.insert("labels".to_string(), json!(br.labels));
    }
...
pub fn diagnostic_to_json(d: &wcl::Diagnostic) -> serde_json::Value {
