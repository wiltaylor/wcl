//! Fundamental shape rendering: the block-side renderers (which resolve
//! anchors against parent dims), the variant-payload renderers (which
//! carry pre-resolved geometry), the shared SVG emitters that both feed,
//! and the box / anchor geometry resolvers.
